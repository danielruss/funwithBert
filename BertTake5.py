...
bert_ckpt_dir = os.path.join("/Users/druss/Downloads/", bert_model_name)
...
print("... loading the Movie Review Data...")
...
print("... finished loading the Movie Review Data in ",
      timeit.default_timer()-t0, " sec.")
